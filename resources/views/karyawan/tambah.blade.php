			...
			<form action="{{ route('karyawan.store') }}" method="POST">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<label>Nama</label>
							<select id="pilihan_karyawan" name="user_id" class="form-control select2 select2-hidden-accessible"
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select required name="pendidikan_terakhir" class="form-control select2 select2-hidden-accessible"
								style="width: 100%;" data-select2-id="2" tabindex="-1" aria-hidden="true">
								<option></option>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<label>Agama</label>\
							<select required name="agama" class="form-control select2 select2-hidden-accessible" style="width: 100%;"
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label>Jabatan</label>
							<select required id="pilihan_jabatan" name="jabatan" class="form-control select2 select2-hidden-accessible"
								style="width: 100%;" data-select2-id="2" tabindex="-1" aria-hidden="true">
								<option value=""></option>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select required name="jenis_kelamin" class="form-control select2 select2-hidden-accessible" style="width: 100%;"
								data-select2-id="2" tabindex="-1" aria-hidden="true">
								<option></option>
